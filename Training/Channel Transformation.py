...
for i in range(allnum):
    ...
    for ii in range(X_train.shape[0]):
        if np.random.rand() < GAUSS_RATE:
            uu=X_train_aug[ii][0][a]
            X_train_aug[ii][0][a]=X_train_aug[ii][0][b]
            X_train_aug[ii][0][b]=uu
            vv=X_train_aug[ii][1][a]
            X_train_aug[ii][1][a]=X_train_aug[ii][1][b]
            X_train_aug[ii][1][b]=vv
