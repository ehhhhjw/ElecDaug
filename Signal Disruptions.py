...
for i in range(allnum):
    ...
    for w in range(4):
        ...
        X_train_aug[a][0][j+1]=(X_train_aug[a][0][j]+X_train_aug[a][0][j+1]+X_train_aug[a][0][j+2])/3.0
        X_train_aug[a][1][j+1]=(X_train_aug[a][1][j]+X_train_aug[a][1][j+1]+X_train_aug[a][1][j+2])/3.0
        X_train_aug[b][0][j+1]=(X_train_aug[b][0][j]+X_train_aug[b][0][j+1]+X_train_aug[b][0][j+2])/3.0
        X_train_aug[b][1][j+1]=(X_train_aug[b][1][j]+X_train_aug[b][1][j+1]+X_train_aug[b][1][j+2])/3.0
